import fs from "fs";
import { bls12_381 } from '../../../examples/noble-curves/src/bls12-381'
import {
    ssz,
} from "@lodestar/types"
...
let g1Bytes = Uint8Array.from([165, 78, 16, 67, 57, 40, 109, 60, 232, 39, 24, 40, 251, 172, 32, 246, 207, 122, 253, 59, 114, 217, 177, 148, 183, 203, 175, 101, 246, 97, 36, 22, 17, 123, 228, 146, 191, 74, 168, 143, 175, 106, 218, 86, 207, 75, 100, 98]);

let g1Point = bls12_381.G1.ProjectivePoint.fromHex(bytesToHex(g1Bytes));

console.log(g1Point.toAffine());
